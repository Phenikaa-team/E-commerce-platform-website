    ...
    <header class="site-header">
        <div class="w-full px-6 sm:px-10 lg:px-14 py-3.5 flex items-center justify-between gap-6">
            ...
            <a href="/" class="flex items-center gap-2.5 shrink-0 group">
                <div class="w-10 h-10 rounded-xl bg-gradient-to-tr from-primary to-rose-400 flex items-center justify-center text-white shadow-md shadow-red-500/20 group-hover:scale-105 transition-transform duration-200">
            ...
            <nav class="hidden md:flex items-center gap-7 text-sm font-medium text-gray-600">
                <a href="/#categories" class="hover:text-primary transition-colors">Danh mục sản phẩm</a>
            ...
            <div class="flex items-center gap-4">
                <div class="hidden sm:block relative w-60 lg:w-80">
                    <input 
                        ...
                        class="w-full pl-4 pr-10 py-2 bg-gray-100 hover:bg-gray-50 focus:bg-white text-xs sm:text-sm text-gray-800 rounded-full border border-transparent focus:border-primary focus:outline-none transition-all placeholder:text-gray-400"
                    >
                ...
                <a href="{{ route('cart') }}" class="relative p-2 text-gray-600 hover:text-primary transition-colors">
                    ...
                    <span class="absolute -top-1 -right-1 w-4 h-4 rounded-full bg-primary text-white text-[10px] font-bold flex items-center justify-center">0</span>
                </a>
                        ...
                        <form action="{{ route('register.post') }}" method="POST" class="space-y-3.5">
                            ...
                            <div>
                                <div class="relative">
                                    ...
                                    <input 
                                        ...
                                        class="auth-input auth-input--compact"
                                    >
                                </div>
                            </div>
                            ...
                            <div>
                                <div class="relative">
                                    ...
                                    <input 
                                        ...
                                        class="auth-input auth-input--compact auth-input--has-action"
                                    >
                                    <button 
                                        type="button" 
                            ...
                            <div class="pt-1">
                                <label class="flex items-start gap-2.5 cursor-pointer text-[11px] text-gray-600 leading-snug">
                                    <input type="checkbox" name="terms" required checked class="w-4 h-4 mt-0.5 rounded text-primary focus:ring-rose-500 border-gray-300 accent-primary">
                                    <span>Tôi đồng ý với <a href="javascript:void(0)" class="text-primary font-semibold hover:underline">Điều khoản dịch vụ</a> và <a href="javascript:void(0)" class="text-primary font-semibold hover:underline">Chính sách bảo mật</a> của ShopMart</span>
                                </label>
                            </div>
                            ...
                            <button 
                                type="submit" 
                                class="auth-submit-btn auth-submit-btn--compact"
                            >
                                Tạo tài khoản
                            </button>
                        </form>
