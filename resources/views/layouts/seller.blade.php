...
<body class="bg-gray-50 text-gray-800 font-sans antialiased flex min-h-screen">
    ...
    <aside class="seller-sidebar">
        ...
        <nav class="flex-1 px-3 py-3 space-y-1 overflow-y-auto custom-scrollbar text-xs">
            ...
            <a href="{{ route('seller.profile') }}" class="seller-nav-item {{ request()->routeIs('seller.profile') || request()->routeIs('seller.dashboard') ? 'is-active' : '' }}">
            ...
            <!-- Sản phẩm -->
            <a href="{{ route('seller.products.index') }}" class="seller-nav-item {{ request()->routeIs('seller.products.*') ? 'is-active' : '' }}">
            ...
            <!-- Đơn hàng -->
            <a href="{{ route('seller.orders.index') }}" class="seller-nav-item justify-between {{ request()->routeIs('seller.orders.*') ? 'is-active' : '' }}">
                ...
                @if($pendingOrdersCount > 0)
                    <span class="px-1.5 py-0.5 rounded-full bg-primary text-white text-[10px] font-extrabold leading-none">{{ $pendingOrdersCount }}</span>
                @endif
            </a>
            ...
            <!-- Doanh thu -->
            <a href="{{ route('seller.revenue') }}" class="seller-nav-item {{ request()->routeIs('seller.revenue') ? 'is-active' : '' }}">
        ...
        <header class="seller-topbar">
            ...
            <div class="flex items-center gap-3.5">
                ...
                <button type="button" class="relative p-2 text-gray-500 hover:text-gray-800 hover:bg-gray-50 rounded-xl transition-colors cursor-pointer">
                    ...
                    <span class="absolute top-1 right-1 w-4 h-4 rounded-full bg-primary text-white text-[10px] font-bold flex items-center justify-center">1</span>
                </button>
